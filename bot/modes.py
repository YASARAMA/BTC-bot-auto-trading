    ...
    "safe": {
        ...
        "params_by_strategy": {
            "breakout": {"entry_period": 40, "exit_period": 20, "atr_stop_mult": 3.0,
                         "min_breakout_atr": 0.5, "trend_filter_period": 100, "volume_min_ratio": 1.5},
    ...
    "balanced": {
        ...
        "params_by_strategy": {
            "breakout": {"entry_period": 20, "exit_period": 10, "atr_stop_mult": 2.0,
                         "min_breakout_atr": 0.25, "trend_filter_period": 100, "volume_min_ratio": 1.5},
    ...
    "aggressive": {
        ...
        "params_by_strategy": {
            "breakout": {"entry_period": 10, "exit_period": 5, "atr_stop_mult": 1.5,
                         "min_breakout_atr": 0.0, "trend_filter_period": 0, "volume_min_ratio": 0.0},
